...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Tên danh mục không được rỗng<br>";
    } else {
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="top-category.php" class="btn btn-primary btn-sm">Xem danh sách danh mục</a>
	</div>
</section>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Hiện thị trên UI? <span>*</span></label>
                    <div class="col-sm-4">
