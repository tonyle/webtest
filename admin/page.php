...
if(isset($_POST['form_about'])) {
    ...
    if(empty($_POST['about_title'])) {
        $valid = 0;
        $error_message .= 'Tiêu đề không được rỗng<br>';
    }

    if(empty($_POST['about_content'])) {
        $valid = 0;
        $error_message .= 'Nội dung không được rỗng<br>';
    }
    ...
    if($path != '') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'các định dạng sau mới có thể tải lên: jpg, jpeg, gif hoặc png<br>';
        }
    }
...
if(isset($_POST['form_faq'])) {
    ...
    if(empty($_POST['faq_title'])) {
        $valid = 0;
        $error_message .= 'Tiêu đề không thể để rỗng<br>';
    }
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Hỏi đáp</a></li>
