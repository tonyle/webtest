...
if(isset($_POST['form1'])) {
    ...
    for($i=1;$i<=count($arr1);$i++) {
        ...
        if($table_quantity[$temp_index] < $arr2[$i]) {
        	$allow_update = 0;
            $error_message .= '"'.$arr2[$i].'" sản phẩm không tồn tại trong "'.$arr3[$i].'"\n';
        } else {
		...
		<div class="row">
			...
			<div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['cart_p_id'])): ?>
                    <?php echo 'Chưa có sản phẩm trong giỏ hàng'; ?>
                <?php else: ?>
                ...
                <div class="row">
                    <div class="col-md-4"><input type="submit" value="Cập nhật giỏ hàng" class="btn btn-primary" name="form1"></div>
                    <div class="col-md-4"><a href="index.php" class="btn btn-primary">Tiếp tục mua sắm</a></div>
                    <div class="col-md-4"><a href="checkout.php" class="btn btn-primary">Mua hàng</a></div>
                </div>
                </form>
                <?php endif; ?>
